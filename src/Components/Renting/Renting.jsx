			...
			<div className='pt-8 pr-8 pb-0 pl-9'>
				<header>
					<div className='flex justify-between items-center'>
						...
						<span className='self-start' onClick={modalNewAutoHandler}>
			...
			<div className='pt-8 pr-8 pb-0 pl-9'>
				<header>
					<div className='flex justify-between items-center'>
						...
						<span className='self-start' onClick={modalUsedAutoHandler}>
							<img src={icon} alt='closing btn' />
						</span>
					</div>
				</header>
				<article>
					<ul className='not-italic font-normal text-sm	list-none	pl-0 mb-6 mt-0'>
						...
						<li>
							&#8211; Первоначальный взнос – от 0% от стоимости автомобиля;
						</li>
			...
			<div className='pt-8 pr-8 pb-0 pl-9'>
				<header>
					<div className='flex justify-between items-center'>
						...
						<span className='self-start' onClick={modalLoanPaymentHandler}>
							<img src={icon} alt='closing btn' />
						</span>
					</div>
				</header>
			...
			<div className='pt-8 pr-8 pb-0 pl-9'>
				<header>
					<div className='flex justify-between items-center'>
						...
						<span className='self-start' onClick={modalInstallmentHandler}>
							<img src={icon} alt='closing btn' />
						</span>
					</div>
				</header>
			...
			<section>
				<div className='grid grid-cols-renting bg-bookmark-white py-14 px-20 '>
					<div className='flex flex-col align-start text-xl font-serif'>
						...
						<p className='text-base	mb-2 mt-5'>Кредит на покупку автомобиля</p>
					...
					<div className='ml-12'>
						<div className='grid grid-cols-2 gap-8'>
							...
							<div className='bg-white shadow-md shadow-neutral-500'>
								...
								<p className='font-sm pl-6 pr-5 my-3.5'>
									...
									возраст автомобиля — 15 лет. Срок кредита – от 6 до 72
									месяцев. Досрочное погашение без комиссии. Специальные ставки
									на покупку автомобилей не старше 5 и 10 лет.
								</p>
						...
						<div className='grid grid-cols-3 mt-8 gap-x-7'>
							...
							<div className='bg-white shadow-md	shadow-neutral-500'>
								...
								<p className='font-sm pl-6 pr-5 my-3.5'>
									Снижению процентной ставки по договору потребительского
									кредита на покупку транспортного средства.
								</p>
								{modalContentGOS}
							</div>
						</div>
